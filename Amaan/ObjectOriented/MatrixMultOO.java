...
public class MatrixMultOO {


    public static void main(String[] args) {

        System.out.println("Matrix A");
        Matrix testMatrix = Matrix.getMatrix();

        System.out.println();

        System.out.println("Matrix B");
        Matrix testMatrix2 = Matrix.getMatrix();

        System.out.println("Matrix A * B is:");
        System.out.println(testMatrix.multiply(testMatrix2).toString());

        System.out.println();

        System.out.println("Matrix A + B is:");
        System.out.println(testMatrix.add(testMatrix2).toString());
    }
}
